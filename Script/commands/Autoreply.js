...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    ...
    "good morning": "GOOD MORNING দাত ব্রাশ করে খেয়ে নেও জান😚",
    "tor ball": "~ এখনো বাল উঠে নাই নাকি তোমার?? 🤖",
    "shahadat": "উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ S H U V O B O S S ☜\nFacebook: https://www.facebook.com/profile.php?id=100082387123597\nWhatsApp: +8801341210072",
    "admin": "He is S H U V O তাকে সবাই Cyber Bot Team Saport Admin হিসেবে চিনে😘☺️",
    ...
    "fork": "https://github.com/ahmedshuvo675/Shuvo.git",
    ...
    "by": "কিরে তুই কই যাস কোন মেয়ের সাথে চিপায় যাবি শুভ বসকে বলে দিবো..!🌚🌶️",
    "ami shuvo": "হ্যা বস কেমন আছেন..?☺️",
    "bot er baccha": "আমার বাচ্চা তো তোমার গার্লফ্রেন্ডের পেটে..!!🌚⛏️",
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌Shuvo Boss💖",
